...
CREATE TABLE games (
	...
	price INT,
	cover BLOB,
	genre ENUM('Аркада', 'Шутер', 'Стратегия', 'RPG'),
	age_rating INT COMMENT 'Возрастной ценз'
);
...
CREATE TABLE calls (
	...
	user_id BIGINT UNSIGNED NOT NULL,
	duration INT,
	subscriber_id VARCHAR(255) COMMENT 'Абонент, с которым велся разговор',
	video_call BOOLEAN
);

-- Сущность "Музыкальные композиции"
